...
const statItems = [
  ...
  },
  {
    ...
    label: "Episodic",
    icon: Activity,
    color: "from-apple-orange/20 to-apple-orange/5",
  ...
  },
  {
    ...
    label: "Semantic",
    icon: Lightbulb,
    color: "from-apple-purple/20 to-apple-purple/5",
  ...
  },
  {
    ...
    label: "Procedural",
    icon: BookOpen,
    color: "from-apple-green/20 to-apple-green/5",
  ...
  return (
    <div className="space-y-4">
      <div className="grid gap-3 grid-cols-2 lg:grid-cols-4">
        {statItems.map((item, i) => {
          ...
          return (
            <div
              key={item.key}
              className="group relative overflow-hidden rounded-2xl border border-border/50 bg-white/[0.05] p-4 transition-all duration-300 hover:bg-white/[0.08] hover:border-border/70 animate-scale-in"
      ...
      <div className="flex gap-3">
        {[
          { label: "Active", value: combined.active, color: "bg-apple-green" },
          { label: "Deprecated", value: combined.deprecated, color: "bg-apple-yellow" },
          { label: "Superseded", value: combined.superseded, color: "bg-apple-blue" },
        ].map((s) => (
          <div
            key={s.label}
            className="flex flex-1 items-center gap-3 rounded-xl border border-border/50 bg-white/[0.05] px-4 py-3 hover:bg-white/[0.08] hover:border-border/70 transition-all duration-200"
          >
