...
export function MemoryGraph({ org, repo, onMemoryClick }: MemoryGraphProps) {
        ...
        <div className="absolute top-4 left-4 flex items-center gap-2 z-10">
          ...
          <div className="rounded-xl border border-border/50 bg-[rgba(28,28,30,0.85)] glass transition-all overflow-hidden">
            <button
              ...
              title={filtersMinimized ? "Expand filters" : "Collapse filters"}
            >
        ...
        >
          ...
          <div className="border-t border-border/20 p-4 space-y-3">
            <Button
              ...
              size="sm"
              className="w-full"
              onClick={() => onMemoryClick?.(selectedNode)}
            >
              View Full Details
            </Button>
